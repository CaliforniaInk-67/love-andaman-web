      ...
      <section className="relative h-[60vh] md:h-[80vh] w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4">
          ...
          <p className="text-xl md:text-2xl text-white font-light drop-shadow-md">
            ผู้บุกเบิกการท่องเที่ยวเชิงอนุรักษ์แห่งทะเลอันดามัน
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold text-[#011a54]">
              จุดเริ่มต้นของ <span className="text-[#00b5e2]">Love Andaman</span>
            </h2>
            <div className="w-20 h-1 bg-[#00b5e2] rounded-full"></div>
            
            <p className="text-gray-600 leading-relaxed font-light">
              เกิดจากความหลงใหลในความงามของท้องทะเลไทย และอยากให้ทุกคนได้สัมผัสประสบการณ์ที่น่าประทับใจไปพร้อมๆ กับการดูแลรักษาทรัพยากรธรรมชาติ 
              เราจึงเริ่มสร้างสรรค์ทริปท่องเที่ยวที่แตกต่าง ภายใต้แนวคิด <span className="font-semibold text-[#011a54]">Eco-Tourism (การท่องเที่ยวเชิงอนุรักษ์)</span>
            </p>
            
            <p className="text-gray-600 leading-relaxed font-light">
              จากนักเดินทางที่หลงรักทะเล สู่ผู้ให้บริการเรือท่องเที่ยวระดับพรีเมียม กว่า 10 ปีที่เรามุ่งมั่นส่งมอบความสุขและความปลอดภัยสูงสุดให้กับนักท่องเที่ยวทุกคน 
              จนก้าวขึ้นเป็นบริษัททัวร์อันดับต้นๆ ของจังหวัดภูเก็ต ที่มีลูกค้าไว้วางใจทั้งชาวไทยและชาวต่างชาติ
            </p>
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-6">
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 flex-1">
                ...
                <p className="text-sm text-gray-500">ปีแห่งประสบการณ์</p>
              </div>
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 flex-1">
                <h3 className="text-4xl font-bold text-[#00b5e2] mb-2">1M+</h3>
                <p className="text-sm text-gray-500">รอยยิ้มของนักท่องเที่ยว</p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-gray-50 py-20 px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 text-center md:text-left">
          ...
          <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-2xl font-bold text-[#011a54] mb-4">วิสัยทัศน์ (Vision)</h3>
            <p className="text-gray-600 font-light leading-relaxed">
              มุ่งสู่การเป็นผู้นำด้านการท่องเที่ยวทางทะเลระดับโลก ที่มอบประสบการณ์สุดพิเศษควบคู่ไปกับการเติบโตอย่างยั่งยืนร่วมกับธรรมชาติและชุมชน
            </p>
          </div>
          ...
          <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-2xl font-bold text-[#011a54] mb-4">พันธกิจ (Mission)</h3>
            <p className="text-gray-600 font-light leading-relaxed">
              ให้บริการด้วยใจ ใส่ใจความปลอดภัยสูงสุด พร้อมผลักดันและสนับสนุนการอนุรักษ์ทรัพยากรทางทะเลให้สวยงามส่งต่อสู่รุ่นต่อไป
            </p>
          </div>
