...
// ─── 1. SEO METADATA FOR THAI PAGE ───
export const metadata: Metadata = {
  title: "Love Andaman | แพ็กเกจทัวร์ทะเลอันดามัน สิมิลัน สุรินทร์ อัปเดต 2026",
  description: "เที่ยวทะเลอันดามันกับ Love Andaman ทัวร์เกาะสิมิลัน เกาะสุรินทร์ เกาะรอก เกาะพีพี บริการระดับพรีเมียม ไกด์น่ารัก อาหารอร่อย เดินทางปลอดภัย",
  keywords: ["Love Andaman", "เลิฟอันดามัน", "ทัวร์สิมิลัน", "ทัวร์เกาะสุรินทร์", "เที่ยวภูเก็ต", "จัดทริปดำน้ำ"],
  openGraph: {
    title: "Love Andaman | แพ็กเกจทัวร์ทะเลอันดามัน บริการระดับพรีเมียม",
    description: "เดินทางสู่สวรรค์แห่งอันดามันกับเรา ทัวร์วันเดียว (One Day Trip) ยอดนิยมพร้อมการดูแลที่ดีที่สุด",
    url: "https://www.yourdomain.com/th",
      ...
      <div className="p-6 flex-grow flex flex-col justify-between">
        <div>
          ...
          <div className="text-sm text-[#4a4a4a] mb-5 space-y-1.5 font-light">
            <span className="font-semibold text-[#011a54]/90 block mb-1">รายละเอียดทัวร์:</span>
            <ul className="space-y-1">
              {pkg.detailsTh.map((detail, index) => (
        ...
        <div className="pt-4 border-t border-gray-100 space-y-4">
          <div className="text-right">
            <span className="text-xs text-gray-400 font-light block">ราคาเริ่มต้น:</span>
            <p className="text-2xl font-bold text-[#011a54]">
              {pkg.priceStarting.toLocaleString()}
              <span className="text-xs font-light text-gray-500 ml-1">บาท/คน</span>
            </p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 text-center">
        <header className="mb-8">
          ...
          <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto font-light leading-relaxed">
            บริษัททัวร์อันดับ 1 ของภูเก็ต ให้บริการแพ็กเกจท่องเที่ยวทะเลอันดามัน หมู่เกาะสิมิลัน หมู่เกาะสุรินทร์ และเกาะพีพี ด้วยบริการระดับพรีเมียม
          </p>
        </header>
